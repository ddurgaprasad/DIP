...
sigma_s =7
sigma_r =10
img1 = cv2.imread(r'C:\SAI\IIIT\2019_Monsoon\DIP\Assignment2\input_data\ravva_upma.jpg')
...
img_out = applyCrossBilateralFilter(img1, img1, sigma_s, sigma_r)
...
#cv2.imwrite(r'C:\SAI\IIIT\2019_Monsoon\DIP\Assignment2\output_data\rgb.jpg', img)
...
#        
#        filename = r"C:\SAI\IIIT\2019_Monsoon\DIP\Assignment2\output_data\file_%d_%d.jpg"%(sigma_r,sigma_s)
#        img=np.concatenate((img1, img2,img_out), axis=1)
#        print(filename)
