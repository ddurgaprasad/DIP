...
def lowpass(im,k,efficent=True):
    ...
    start = time.time()
    if efficent:
        filtered_im = applyFastFilter(im,fil)
...
plt.imshow(getGaussianKernel(5,1.0),cmap='gray')
 
#from PIL import Image    

#im = Image.open(r'C:\SAI\IIIT\2019_Monsoon\DIP\Assignment2\input_data\barbara.jpg')
#im = np.array(im)
#t,new_im = lowpass(im,7,False) 
#
#plt.imshow(new_im,cmap='gray')
