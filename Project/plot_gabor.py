...
brick = skimage.io.imread(os.path.join(images_path,'1.jpg'))[shrink]
grass = skimage.io.imread(os.path.join(images_path,'4.jpg'))[shrink]
gravel = skimage.io.imread(os.path.join(images_path,'7.jpg'))[shrink]
